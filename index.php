  ...
  <div class="carousel-inner">
    <?php
        ...
        //foreach($images as $key => $img){
                //echo ($key == 0 or $key == 1 or $key == 2) ? '<div class="carousel-item active">' : '<div class="carousel-item">';
        ...
        >
          ...
          <div class="carousel-inner">
            ...
            <div class="carousel-item active">
              <img
                src="https://cloudgroup7.s3.amazonaws.com/assets/images/$images[0]"
                class="d-block w-100"
                alt="..."
              />
             </div>
            ...
            <div class="carousel-item">
              <img
                src="https://cloudgroup7.s3.amazonaws.com/assets/images/$images[1]"
                class="d-block w-100"
                alt="..."
              />             
            </div>
            ...
            <div class="carousel-item">
              <img
                src="https://cloudgroup7.s3.amazonaws.com/assets/images/$images[2]"
                class="d-block w-100"
                alt="..."
              />
             </div>
